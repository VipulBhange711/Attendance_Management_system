                  ...
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                      ...
                      <li class=" ">
                          ...
                          <ul id="product" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                              <li class="">
                                  <a href="{{asset('backend/page-list-product.html')}}">
                                      <i class="las la-minus"></i><span>List Product</span>
                                  </a>
                              </li>
                              <li class="">
                                  <a href="{{asset('backend/page-add-product.html')}}">
                      ...
                      <li class=" ">
                          ...
                          <ul id="category" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                  <li class="">
                                          <a href="{{asset('backend/page-list-category.html')}}">
                                              <i class="las la-minus"></i><span>List Category</span>
                                          </a>
                                  </li>
                                  <li class="">
                                          <a href="{{asset('backend/page-add-category.html')}}">
                      ...
                      {{-- <li class=" ">
                          ...
                          <ul id="sale" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                  <li class="">
                                          <a href="{{asset('backend/page-list-sale.html')}}">
                                              <i class="las la-minus"></i><span>List Sale</span>
                                          </a>
                                  </li>
                                  <li class="">
                                          <a href="{{asset('backend/page-add-sale.html')}}">
                      ...
                      <li class=" ">
                          ...
                          <ul id="purchase" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                  <li class="">
                                          <a href="{{asset('backend/page-list-purchase.html')}}">
                                              <i class="las la-minus"></i><span>List Purchases</span>
                                          </a>
                                  </li>
                                  <li class="">
                                          <a href="{{asset('backend/page-add-purchase.html')}}">
                      ...
                      <li class=" ">
                          ...
                          <ul id="return" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                  <li class="">
                                          <a href="{{asset('backend/page-list-returns.html')}}">
                                              <i class="las la-minus"></i><span>List Returns</span>
                                          </a>
                                  </li>
                                  <li class="">
                                          <a href="{{asset('backend/page-add-return.html')}}">
                      ...
                      <li class=" ">
                          ...
                          <ul id="people" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                  <li class="">
                                          <a href="{{asset('backend/page-list-customers.html')}}">
                                              <i class="las la-minus"></i><span>Customers</span>
                                          </a>
                                  </li>
                                  <li class="">
                                          <a href="{{asset('backend/page-add-customers.html')}}">
                                              <i class="las la-minus"></i><span>Add Customers</span>
                                          </a>
                                  </li>
                                  <li class="">
                                          <a href="{{asset('backend/page-list-users.html')}}">
                                              <i class="las la-minus"></i><span>Users</span>
                                          </a>
                                  </li>
                                  <li class="">
                                          <a href="{{asset('backend/page-add-users.html')}}">
                                              <i class="las la-minus"></i><span>Add Users</span>
                                          </a>
                                  </li>
                                  <li class="">
                                          <a href="{{asset('backend/page-list-suppliers.html')}}">
                                              <i class="las la-minus"></i><span>Suppliers</span>
                                          </a>
                                  </li>
                                  <li class="">
                                          <a href="{{asset('backend/page-add-supplier.html')}}">
                      ...
                      <li class="">
                          <a href="{{asset('backend/page-report.html')}}" class="">
                          ...
                          <ul id="otherpage" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                  <li class=" ">
                                      ...
                                      <ul id="user" class="iq-submenu collapse" data-parent="#otherpage">
                                              ...
                                              <li class="">
                                                  <a href="{{asset('app/user-add.html')}}">
                                                      <i class="las la-minus"></i><span>User Add</span>
                                                  </a>
                                              </li>
                                              <li class="">
                                                  <a href="{{asset('app/user-list.html')}}">
                                  ...
                                  <li class=" ">
                                      ...
                                      <ul id="auth" class="iq-submenu collapse" data-parent="#otherpage">
                                              <li class="">
                                                  <a href="{{asset('backend/auth-sign-in.html')}}">
                                                      <i class="las la-minus"></i><span>Login</span>
                                                  </a>
                                              </li>
                                              <li class="">
                                                  <a href="{{asset('backend/auth-sign-up.html')}}">
                                                      <i class="las la-minus"></i><span>Register</span>
                                                  </a>
                                              </li>
                                              <li class="">
                                                  <a href="{{asset('backend/auth-recoverpw.html')}}">
                                                      <i class="las la-minus"></i><span>Recover Password</span>
                                                  </a>
                                              </li>
                                              <li class="">
                                                  <a href="{{asset('backend/auth-confirm-mail.html')}}">
                                                      <i class="las la-minus"></i><span>Confirm Mail</span>
                                                  </a>
                                              </li>
                                              <li class="">
                                                  <a href="{{asset('backend/auth-lock-screen.html')}}">
                                  ...
                                  <li class="">
                                      ...
                                      <ul id="form" class="iq-submenu collapse" data-parent="#otherpage">
                                          <li class="">
                                              <a href="{{asset('backend/form-layout.html')}}">
                                                  <i class="las la-minus"></i><span class="">Form Elements</span>
                                              </a>
                                          </li>
                                          <li class="">
                                              <a href="{{asset('backend/form-input-group.html')}}" class="svg-icon">
                                                 <i class="las la-minus"></i><span class="">Form Input</span>
                                              </a>
                                          </li>
                                          <li class="">
                                              <a href="{{asset('backend/form-validation.html')}}" class="svg-icon">
                                                  <i class="las la-minus"></i><span class="">Form Validation</span>
                                              </a>
                                          </li>
                                          <li class="">
                                              <a href="{{asset('backend/form-switch.html')}}" class="svg-icon">
                                                  <i class="las la-minus"></i><span class="">Form Switch</span>
                                              </a>
                                          </li>
                                          <li class="">
                                              <a href="{{asset('backend/form-chechbox.html')}}" class="svg-icon">
                                                  <i class="las la-minus"></i><span class="">Form Checkbox</span>
                                              </a>
                                          </li>
                                          <li class="">
                                              <a href="{{asset('backend/form-radio.html')}}" class="svg-icon">
                                                  <i class="las la-minus"></i><span class="">Form Radio</span>
                                              </a>
                                          </li>
                                          <li class="">
                                              <a href="{{asset('backend/form-textarea.html')}}" class="svg-icon">
                                  ...
                                  <li class=" ">
                                      ...
                                      <ul id="table" class="iq-submenu collapse" data-parent="#otherpage">
                                              <li class="">
                                                  <a href="{{asset('backend/tables-basic.html')}}">
                                                      <i class="las la-minus"></i><span>Basic Tables</span>
                                                  </a>
                                              </li>
                                              <li class="">
                                                  <a href="{{asset('backend/table-data.html')}}">
                                                      <i class="las la-minus"></i><span>Data Table</span>
                                                  </a>
                                              </li>
                                              <li class="">
                                                  <a href="{{asset('backend/table-tree.html')}}">
                                  ...
                                  <li class=" ">
                                      ...
                                      <ul id="pricing" class="iq-submenu collapse" data-parent="#otherpage">
                                              <li class="">
                                                  <a href="{{asset('backend/pricing.html')}}">
                                                      <i class="las la-minus"></i><span>Pricing 1</span>
                                                  </a>
                                              </li>
                                              <li class="">
                                                  <a href="{{asset('backend/pricing-2.html')}}">
                                  ...
                                  <li class="">
                                      <a href="{{asset('backend/pages-invoice.html')}}" class="svg-icon">
                                  ...
                                  <li class=" ">
                                      ...
                                      <ul id="pages-error" class="iq-submenu collapse" data-parent="#otherpage">
                                              <li class="">
                                                  <a href="{{asset('backend/pages-error.html')}}">
                                                      <i class="las la-minus"></i><span>Error 404</span>
                                                  </a>
                                              </li>
                                              <li class="">
                                                  <a href="{{asset('backend/pages-error-500.html')}}">
                                  ...
                                  <li class="">
                                          <a href="{{asset('backend/pages-blank-page.html')}}">
                                  ...
                                  <li class="">
                                          <a href="{{asset('backend/pages-maintenance.html')}}">
